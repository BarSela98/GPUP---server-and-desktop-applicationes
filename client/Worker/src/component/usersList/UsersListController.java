...
public class UsersListController implements Closeable {
    WorkerPageController workerPageController;
    ...
    private ObservableList <User> newItems = FXCollections.observableArrayList();
    ...
    public void setMainController(WorkerPageController workerPageController) {
        this.workerPageController = workerPageController;
    }
